...
def load_and_prepare_data(train_path, test_path, target_column):
    """
...
def main():
    ...
    X_val_sampled = X_val.sample(frac=0.5, random_state=42)
    y_val_sampled = y_val.loc[X_val_sampled.index]
    X_test_sampled = X_test.sample(frac=0.4, random_state=42)
    y_test_sampled = y_test.loc[X_test_sampled.index]
    
    # Initialize and train model
    classifier = XGBoostClassifier()
    classifier.train(X_train_sampled, y_train_sampled, X_val_sampled, y_val_sampled)
    
    # Evaluate on training set
    print("\nTraining Set Evaluation:")
    print("------------------------")
    classifier.evaluate(X_train_sampled, y_train_sampled)
    
    # Evaluate on validation set
    print("\nValidation Set Evaluation:")
    print("-------------------------")
    classifier.evaluate(X_val_sampled, y_val_sampled)
    
    # Evaluate on test set
    print("\nTest Set Evaluation:")
    print("-------------------")
    classifier.evaluate(X_test_sampled, y_test_sampled)
